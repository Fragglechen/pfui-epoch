pfUI:RegisterModule("gui", "vanilla:tbc:wotlk", function ()
  ...
  do -- Generate Config UI
    ...
    CreateGUIEntry(T["Actionbar"], T["General"], function()
      ...
      CreateConfig(function()
        ...
        if pfUI and pfUI.bars and pfUI.bars.UpdateConfig then
          pfUI.bars:UpdateConfig()
        end
      end, T["Lock Actionbars"], C.bars, "lockactionbars", "checkbox")
