pfUI:RegisterModule("autovendor", "vanilla:tbc:wotlk", function ()
  ...
  autovendor.button.icon:SetTexture("Interface\\Buttons\\UI-GroupLoot-Pass-Up")
  autovendor.button.icon:SetTexCoord(0, 1, 0, 1)
