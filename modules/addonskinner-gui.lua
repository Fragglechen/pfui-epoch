-- load pfUI environment
  ...
  function pfUI.addonskinner:LoadGui()
    ...
    if self.guiLoaded then return end
    local addonSkinnerName = "Addon Skinner"
    local addonSkinnerVersion = "integrated"
    ...
    if old_gui then
      ...
      if pfUI.gui.tabs.thirdparty then
        pfUI.gui.tabs.thirdparty.tabs.addonskinner = pfUI.gui.tabs.thirdparty.tabs:CreateTabChild(addonSkinnerName, true)
        self.guiLoaded = true
      ...
      CreateGUIEntry(T["Thirdparty"], addonSkinnerName, function()
        ...
        CreateConfig(nil, T["Version"] .. ": " .. addonSkinnerVersion, nil, nil, "header")
