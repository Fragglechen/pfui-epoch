pfUI:RegisterSkin("tracking", "vanilla:tbc:wotlk", function ()
  if not MINIMAP_TRACKING_FRAME then return end
  if not MINIMAP_TRACKING_FRAME.SetNormalTexture then return end
