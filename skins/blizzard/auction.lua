pfUI:RegisterSkin("Auctionhouse", "vanilla:tbc", function ()
  ...
  HookAddonOrVariable("Blizzard_AuctionUI", function()
    ...
    if type(_G.AuctionFrame_OnShow) == "function" then
    ...
    do -- Bid Tab
      ...
      if type(_G.AuctionFrameBid_Update) == "function" then
    ...
    do -- Auctions Tab
      ...
      if type(_G.AuctionFrameAuctions_Update) == "function" then
      ...
      if type(_G.AuctionSellItemButton_OnEvent) == "function" then
